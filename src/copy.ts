export default {
  en: {
    ...
    howToPlay:
      'Follow the beating red dot to build a moving line to draw one of our most beloved Ray-Ban Icon styles.\nYou should tap up, down, right or left side of your screen to make the line go that side.\nComplete each style to move to the next level.\nAvoid colliding with your own line or against the wall, if you do, game is over.\nYou have 3 lives to complete the game and win a special price.',
    start: 'Begin',
    goToLevelOne: 'Go to level 1',
    goToNextLevel: 'Next Level',
    rotateToLandscape: 'Please rotate your phone',
    youreOn: 'You’re on!',
    levelCompleted: 'Level Completed!',
    level1Header: 'The Round sees the unimaginable take place.',
    level1Copy:
    ...
    level2Header: 'The Aviator takes you higher than the rest',
    level2Copy:
    ...
    level3Header: 'The Wayfarer takes you farther than you ever thought',
    level3Copy:
      'Born to wander, the Wayfarer has never stood still. In the early ‘50s, as moldable plastics entered the scene, the Wayfarer shifted sunglasses from function to style and the rest is history. Today, the Wayfarer continues to challenge the unexplored with timeless swagger.',
    level4Header: 'The Clubmaster masters the game hands down.',
    level4Copy:
